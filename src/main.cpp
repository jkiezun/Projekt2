...
int main(){
    ...
    emp.set_solary(13000);
    emp.set_count_of_publication(222);
    show_employee(emp.get_name(), emp.get_surname(),emp.get_solary(), emp.get_count_of_publication());
    cout<<endl;

    Employee <short int> emp2;
    emp2.set_name("Jan");
    emp2.set_surname("Nowak");
    emp2.set_solary(1300);
    emp2.set_count_of_publication(2);

    Employee <int> emp3;
    emp3.set_name("Jan");
    emp3.set_surname("Nowak");
    emp3.set_solary(1300);
    ...
    facul.show_list_of_employyes_2();
    cout<<endl;
    facul.add_short_employee(emp2);
    facul.show_list_of_employyes_1();
    cout<<endl;
    cout<<endl;
